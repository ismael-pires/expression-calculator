/**
* Expression Calculator - Main Screen
*
* @Ismael Pires
*/
...
render() {
	...
	return (
		...
		<View style={styles.column_one}>
			<TextInput
				style={{
					flex : 60, textAlign: 'right', fontSize: this.state.fontSize, fontWeight: 'bold', backgroundColor: '#FFFFFF',
					paddingRight: 20, marginTop: 20, color: '#4F4F4F'
				}}
				placeholder= '0'
				maxLength = {50}
				keyboard='number'
			...
			/>
			<TextInput style={{
					flex : 40, textAlign: 'right', fontSize: 40, fontWeight: 'bold', backgroundColor: '#FFFFFF',
